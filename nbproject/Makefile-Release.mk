...
${OBJECTDIR}/fileoperations.o: fileoperations.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fileoperations.o fileoperations.c

${OBJECTDIR}/hanoi_engine.o: hanoi_engine.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hanoi_engine.o hanoi_engine.c
